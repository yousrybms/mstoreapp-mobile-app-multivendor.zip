...
class Mstoreapp_Mobile_App {
	...
	private function define_public_hooks() {
        ...
        $this->loader->add_filter( 'posts_clauses', $plugin_multivendor, 'mstoreapp_location_filter', 100, 2);

        //For WC Marketplace geo user query
        $this->loader->add_action( 'pre_user_query', $plugin_multivendor, 'geo_location_user_query', 10, 1  );
